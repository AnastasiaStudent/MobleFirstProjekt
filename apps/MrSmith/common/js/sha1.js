...
//
///*
// * Convert a raw string (to a hex string) to a string of different signs
// */
function rstr2hex(input, number, sign, capital) {

	//password restriction: 1 := ON; 0:=OFF.
	var s_number = number;
	var s_sign = sign;
...
* output Array aus 9-stellige zahlen
*/
